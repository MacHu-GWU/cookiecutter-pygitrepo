...
print_colored_line $color_cyan "[DOING] build lambda dependencies layer at ${path_lambda_layer_file} in container ${docker_image_for_build} ..."
mkdir -p ${path_build_lambda_dir}
script_path=${dir_container_workspace}/bin/lbd/build-lbd-layer-in-container.sh

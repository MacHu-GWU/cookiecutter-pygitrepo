...
print_colored_ref_line ${color_light_blue} "lambda package source code" "${s3_uri_lambda_source_file_prefix}-{md5-checksum}.zip"
print_colored_ref_line ${color_light_blue} "lambda package dependencies layer" ${s3_uri_lambda_layer_file}

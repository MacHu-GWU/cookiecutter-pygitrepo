...
copyright = '%s, {{ cookiecutter.author_name }}' % datetime.utcnow().year
...
html_logo = "./_static/{{ cookiecutter.package_name }}-logo.png"
html_favicon = "./_static/{{ cookiecutter.package_name }}-favicon.ico"
...
package_name = {{ cookiecutter.package_name }}.__name__

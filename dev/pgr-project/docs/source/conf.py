# -*- coding: utf-8 -*-
#
# pgr documentation build configuration file, created by
...
version = pgr.__version__
# The full version, including alpha/beta/rc tags.
release = pgr.__version__
...
html_logo = "./_static/pgr-logo.png"
html_favicon = "./_static/pgr-favicon.ico"
...
latex_documents = [
    (master_doc, 'pgr.tex', 'pgr Documentation',
     u'Sanhe Hu', 'manual'),
]
...
man_pages = [
    (master_doc, 'pgr', 'pgr Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pgr', 'pgr Documentation',
     author, 'pgr', 'One line description of project.',
     'Miscellaneous'),
]
